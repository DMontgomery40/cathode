...
DEFAULT_REPO_URL = "https://github.com/DMontgomery40/bettube-studio.git"
DEFAULT_CHECKOUT_DIR = Path.home() / ".cache" / "bettube-studio"
...
def build_output(
    *,
    ...
    mcp_http_command = [
        "env",
        f"BETTUBE_STUDIO_MCP_PORT={mcp_port}",
        str(venv_python),
