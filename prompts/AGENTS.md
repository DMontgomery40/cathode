...
- Do not hand-author storyboard examples for betTube Studio prompts.
...
- Prompt work must preserve both halves of betTube Studio:
...
- Judge prompt changes by the outputs betTube Studio can actually normalize and preview, not by prose quality alone.
